        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">اذونات جديده</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                   (تحويل) اضافة اذن استلام من مخزن رئيسي</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card card-success">
                ...
                <div class="card-body ">
                    ...
                    <form action="{{ route('mainwhearhousincome.store') }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="factoryName" class="control-label">جهة الإستلام</label>
                                <select id="factoryName" name="factoryName" class="form-control js-example-basic-single">
                                    <option value="" selected disabled> اختر اسم جهة الإستلام</option>
