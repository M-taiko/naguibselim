...
@endsection
@section('title')
(تحويل)  اضافه اذن استلام من مخزن رئيسي 
@stop
        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">اذونات جديده</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    اضافه اذن استلام من مخزن رئيسي   (تحويل) </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card card-danger">
                ...
                <div class="card-body ">
                    ...
                    <form action="{{ route('infrommainwhearhouse.store') }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control " name="quantity" placeholder="ادخل الكميه المكتوبه علي الاذن"
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="ordertype" class="control-label">   نوع الإذن</label>
                                    ...
                                    <option value="استلام من مخزن رئيسي" selected >استلام من مخزن رئيسي</option>
                                    </select>
                            </div>
                            ...
                            <div class="col">
                                <label for="factoryName" class="control-label">الجهه المحول منها   </label>
                                <select id="factoryName" name="factoryName" class="form-control">
                                    <option value="" selected disabled> الجهه المحول منها </option>
                                    <?php
