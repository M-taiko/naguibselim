...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">  التقارير </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تقرير مجمع  </span>
						</div>
					</div>
					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							<div class="card-header pb-0">
                                ...
                                <form action="/complexreport/search" method="POST" role="search" autocomplete="off">
                                    {{ csrf_field() }}
