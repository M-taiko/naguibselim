...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto"> إدارة الإمداد </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تقارير يوميه</span>
						</div>
					</div>
					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							<div class="card-header pb-0">
                                ...
                                <form action="/dailyreport/search" method="POST" role="search" autocomplete="off">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                        <label class="rdiobox"><input name="rdio" value="2" type="radio"><span>بحث برقم الإذن
                                            </span></label>
                                    </div><br><br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="invoice_number">
                                            <p class="mg-b-10">البحث برقم الإذن</p>
