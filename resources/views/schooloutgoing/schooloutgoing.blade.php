        ...
        <div class="col-lg-12 col-md-12">
            <div class="card card-danger">
                ...
                <div class="card-body ">
                    ...
                    <form action="{{ route('schooloutgoing.store') }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="ordertype" class="control-label">   نوع الإذن</label>
                                    ...
                                    <option value="صرف الي مدارس" selected >صرف الي  مدارس</option>
                                    </select>
                            </div>
                            ...
                            <div class="col">
                                <label for="contractor" class="control-label">  اسم المدرسه   </label>
                                   
                                <select id="contractor" name="contractor" class="form-control js-example-basic-single" required>
                                    <option value="" selected disabled> اختر اسم المدرسه</option>
