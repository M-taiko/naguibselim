					   ...
					   <div class="modal-dialog" role="document">
						  <div class="modal-content">
							  ...
							  <div class="modal-body">
								  ...
								  <form action="SecounderyWearHouse/update"  method="post" autocomplete="off">
										{{method_field('patch')}}
										{{csrf_field()}}
					 ...
					 <div class="modal" id="modaldemo9">
						 <div class="modal-dialog modal-dialog-centered" role="document">
							 <div class="modal-content modal-content-demo">
                                ...
                                <form action="SecounderyWearHouse/destroy " method="post">
                                    {{method_field('delete')}}
                                    {{csrf_field()}}
                                    <div class="modal-body">
		...
		<div class="modal" id="modaldemo8">
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
					...
					<div class="modal-body">
						<form action="{{route('SecounderyWearHouse.store')}}" method="post">
							{{csrf_field()}}
