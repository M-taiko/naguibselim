        ...
        <div class="col-lg-12 col-md-12">
            <div class="card card-success">
                ...
                <div class="card-body ">
                    ...
                    <form action="{{ route('mainincome.store') }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="ordertype" class="control-label">   نوع الإذن</label>
                                    ...
                                    <option value="استلام من مورد" selected > استلام من مورد </option>
                                    </select>
                            </div>
                            ...
                            <div class="col">
                                <label for="factoryName" class="control-label">المصنع</label>
                                <select id="factoryName" name="factoryName" class="form-control">
                                    <option value="المورد" selected disabled> اختر اسم المورد</option>
                                    <option value="مصنع سايلو " > مصنع سايلو  </option>
                                    <option value="مصنع ريو" > مصنع ريو  </option>
                                    <option value=" مصنع الناصر" > مصنع الناصر  </option>
                                    <option value="مصنع سيتي فودز" >مصنع سيتي فودز </option>
                                    <option value="مصنع الرضوي" >مصنع الرضوي </option>
                                    <option value="مصنع هاني ويل" >مصنع هاني ويل </option>
                                    <option value="مصنع وزاره الزراعه" >مصنع وزاره الزراعه</option>
                                    <option value="مصنع  المحافظه" >مصنع  المحافظه </option>
                                    <option value="مصنع ايميكو" >مصنع ايميكو </option>
                                    <option value="مصنع ايجيبت تريد" >مصنع ايجيبت تريد </option>
