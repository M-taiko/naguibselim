	...
	<div class="main-sidebar-header active">
		...
		<a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/favicon.png')}}" class="logo-icon dark-theme" alt="logo"></a>
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category"> Naguib Seilm</li>
					<li class="slide">
					...
					@can('مندوب')
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label"> قسم  المندوب </span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<!--<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">المخازن الفرعيه </a></li> -->
							<li><a class="slide-item" href="{{ url('/' . $page='recive') }}">   طلب استلام  نقدية من خزينة  </a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='pay') }}">   طلب صرف نقدية من العهدة   </a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='userTransactions') }}"> حركات الإستلام والصرف الخاصه بالمندوب </a></li>
					...
					@can('محاسب')
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label"> قسم المحاسب </span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<!--<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">المخازن الفرعيه </a></li> -->
							<li><a class="slide-item" href="{{ url('/' . $page='reciveTotreasury') }}">   طلب استلام  نقدية الي خزينة  </a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='payFromTresury') }}">   طلب صرف نقدية من خزينة   </a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='transaction') }}">  جميع حركات الإستلام والصرف  </a></li>
			...
			@can('إداره')
				...
				<li class="side-item side-item-category">  التنظيم والإداره </li>
				<li class="slide">
					<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M6.26 9L12 13.47 17.74 9 12 4.53z" opacity=".3"/><path d="M19.37 12.8l-7.38 5.74-7.37-5.73L3 14.07l9 7 9-7zM12 2L3 9l1.63 1.27L12 16l7.36-5.73L21 9l-9-7zm0 11.47L6.26 9 12 4.53 17.74 9 12 13.47z"/></svg><span class="side-menu__label">إداره </span><i class="angle fe fe-chevron-down"></i></a>
				
						<ul class="slide-menu">
							
							<li><a class="slide-item" href="{{ url('/' . $page='cases') }}">حالات </a></li>
							
							<li><a class="slide-item" href="{{ url('/' . $page='treasury') }}">الخزائن  </a></li>
							
						

							<li><a class="slide-item" href="{{ url('/' . $page='suppliers') }}">مناديب</a></li>
							
							
							{{-- <li><a class="slide-item" href="{{ url('/' . $page='products') }}">الإصناف</a></li> --}}
							
							
						<hr>
							
							<li><a class="slide-item" href="{{ url('/' . $page='users') }}">الموظفين</a></li>
						
							
							<li><a class="slide-item" href="{{ url('/' . $page='roles') }}">صلاحيات </a></li>
