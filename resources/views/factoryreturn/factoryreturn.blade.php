        ...
        <div class="col-lg-12 col-md-12">
            <div class="card card-success">
                ...
                <div class="card-body ">
                    ...
                    <form action="{{ route('factoryreturn.store') }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="ordertype" class="control-label">   نوع الإذن</label>
                                    ...
                                    <option value="مرتجع الي مورد" selected >مرتجع الي مورد</option>
                                    </select>
                            </div>
                            ...
                            <div class="col">
                                <label for="contractor" class="control-label">جهه الإرتجاع</label>
                                <select id="contractor" name="contractor" class="form-control">
                                    <option value="المورد" selected disabled> اختر اسم جهه الإرتجاع </option>
