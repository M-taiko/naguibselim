...
@section('title')
    اضافة مستخدم - برنامج  إدارة  زكاة المال
@stop
            ...
            <div class="card-body">
                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    ...
                    <div class="row row-sm mg-b-20">
                        <div class="col-lg-6">
                            <label class="form-label"> المخزن المسؤل عنه الموظف</label>
                            <select name="whearhousname" id="select-beast" class="form-control  js-example-basic-single">

                                <?php
                                /*
                                $whearhouses = DB::table('main__whearhouses')->select('id','WhearHouseName')->get();
                                foreach ($whearhouses as $whearhouse)
                                echo "<option value='" . $whearhouse->WhearHouseName ."' > $whearhouse->WhearHouseName </option>";   
                             */
                                ?>
