        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">اذونات جديده</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    طلب استلام نقدية من خزينة   </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card card-success">
                ...
                <div class="card-body ">
                    ...
                    <form action="{{ route('transaction.recive_request') }}" method="post" enctype="multipart/form-data"
                    autocomplete="off">
                    {{ csrf_field() }}
                    {{-- 1 --}}
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label for="transaction_type" class="control-label">   نوع الإستلام</label>
                                ...
                                <option value="عهده" selected > عهده </option>
                        ...
                        <div class="col">
                            <label for="treasury" class="control-label">اسم الخزينة</label>
                            <select id="treasury" name="treasury" class="form-control js-example-basic-single" required>
