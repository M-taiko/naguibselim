...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto"> إدارة  </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/  حركات الصرف واللإستلام الخالصه ب {{ auth()->user()->name }}
            </span>
        </div>
    </div>
...
<script type="text/javascript">
  $(function() {
    var table = $('#transaction').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{ route('userTransactions.getUsertransactionTable') }}",
        columns: [
            { data: 'id', name: 'id' },
